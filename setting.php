        ...
        <form method="post" action="options.php">
            ...
            <table class="form-table">
                ...
                <tr>
                    ...
                    <td>
                        <input name="title" type="text" id="title" value="<?php echo esc_attr(get_option('title')); ?>"
                ...
                <tr>
                    ...
                    <td>
                        <input name="host" type="text" id="host" value="<?php echo esc_attr(get_option('host')); ?>"
                               class="regular-text ltr">
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <input name="email" type="text" id="email" value="<?php echo esc_attr(get_option('email')); ?>"
                               class="regular-text ltr">
                ...
                <tr>
                    ...
                    <td>
                        <input name="key" type="text" id="key" value="<?php echo esc_attr(get_option('key')); ?>"
                               class="regular-text ltr">
                        <p class="description" id="key-description">请在这里设置查看你的密钥 <a
                                href="https://hacpai.com/settings#soloKey" target="_blank">hacpai.com/settings</a></p>
                    </td>
                </tr>
                <tr>
                    <th scope="row"><label
                            for="sync_category">选择同步 <?php echo esc_attr(get_option('sync_category')); ?></label></th>
                    <td>
                        <select name="sync_category" id="sync_category" class="postform">
                            <option class="level-0" value="2" <?php
                            if (esc_attr(get_option('sync_category')) == '2') {
                                echo 'selected="selected"';
                            } ?>>双向
                            </option>
                            <option class="level-0" value="1" <?php
                            if (esc_attr(get_option('sync_category')) == '1') {
                                echo 'selected="selected"';
                            } ?>>博客到黑客派
                            </option>
                            <option class="level-0" value="0"
                                <?php
                                if (esc_attr(get_option('sync_category')) == '0') {
                                    echo 'selected="selected"';
                                } ?>>关闭
                            </option>
                        </select>
